...
fs = 1000
raw = mne.io.read_raw_brainvision("20240129_B71_stroop5mins_0002.vhdr")

raw.set_channel_types({'ECG':'ecg'})
raw.set_channel_types({'vEOG':'eog'})
raw.set_channel_types({'hEOG':'eog'})

raw_ecg = raw.copy().crop(tmin = 17.377, tmax = 918.137).pick_types(eeg=False, eog=False, ecg=True)
