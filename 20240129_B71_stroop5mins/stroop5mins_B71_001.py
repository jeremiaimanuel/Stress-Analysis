# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 12:20:25 2024
...
########## Save ICA Analysis ##########
ica.save(fname="20240129_stroop5mins/20240129_B71_stroop5mins_0002-ica.fif", overwrite = True)
########## Save ICA Analysis ##########
...
# ica.plot_sources(raw_temp, picks= (12,13,19,25), show_scrollbars=True)
