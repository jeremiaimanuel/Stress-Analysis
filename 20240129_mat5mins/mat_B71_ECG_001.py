...
fs = 1000
raw = mne.io.read_raw_brainvision("20240129_mat5mins_001.vhdr")

raw.set_channel_types({'ECG':'ecg'})
raw.set_channel_types({'vEOG':'eog'})
raw.set_channel_types({'hEOG':'eog'})

raw_ecg = raw.copy().crop(tmin = 17.101, tmax = 918.461).pick_types(eeg=False, eog=False, ecg=True)
...
new_values = [732495, 733050]

new_r_peak = np.insert(new_r_peak, [start_index+1, end_index], new_values)
